...
And this is the reason to import _React_ in the module eventhough we dont explicitly use it.
...
_'react'_ when needed. With new JSX transform, our App component would compile from this
