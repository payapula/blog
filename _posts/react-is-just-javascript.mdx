...
To get to know about JSX, head-over to [JSX on react docs](https://reactjs.org/docs/introducing-jsx.html).
...
this virtual DOM would be synced with real DOM and during this process `<h1>` tag is added to real DOM. This process is called 
...
Test your understanding by taking the quiz by visiting the below link
