...
<iframe src="https://codesandbox.io/embed/github/ghughes13/FCC-MarkdownPreviewer/tree/master/markdown?fontsize=14&hidenavigation=1&module=%2Fsrc%2FApp.js&theme=dark&view=editor"
     style={ {
  width: "100%",
  height: "500px",
  border: "0",
