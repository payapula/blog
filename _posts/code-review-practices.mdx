...
- When raising PRs for bugfix, it should definitely have these items
...
- Do not put hard restrictions on number of lines in a file. Instead prefer to have a general guideline
...
We can use [new-component utility](https://github.com/joshwcomeau/new-component) to create components file structure like this easily.

- Try to create as much custom hooks as you can, and reuse them throughout the code base. If you are spotting a `useEffect` in a PR, then
...
All these are suggestions, and **it's okay to be not strict** about something unless you think it will creates some serious issues 
down the line.
