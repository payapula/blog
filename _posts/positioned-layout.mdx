...
date: '2021-11-02'
description: "This post acts as notes for Module 2 of Josh Comeau's Course CSS for JavaScript Developers. its an excellent course if you want to understand CSS. As a way of Learning in Public, I wanted to write out things, I learned from that course, it would help me stay in focus and actually learn."
cover: 
...
_This post acts as notes for Module 2 of Josh Comeau's Course [CSS for JavaScript Developers](https://courses.joshwcomeau.com/CSS-for-js). its an excellent course if you want to understand CSS. As a way of Learning in Public, I wanted to write out things, I learned from that course, it would help me stay in focus and actually learn._
